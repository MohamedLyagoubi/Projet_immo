<section class="team-section sec-pad centred bg-color-1">
            ...
            <div class="auto-container">
                <div class="sec-title">
                <h5>Nos agents</h5>
<h2>Découvrez nos excellents agents</h2>
</div>
    ...
    <div class="team-block-one">
        <div class="inner-box">
            ...
            <div class="lower-content">
                <div class="inner">
                    <h4><a href="agents-details.html">Rachid El Bakri</a></h4>
                    <span class="designation">Agent principal</span>
                    ...
                    <div class="team-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="inner">
                                    <h4><a href="agents-details.html">Oceane Skyette</a></h4>
                                    <span class="designation"> Agent Sénior</span>
                                    <ul class="social-links clearfix">
                                        <li><a href="index.html"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="index.html"><i class="fab fa-twitter"></i></a></li>
                                        <li><a href="index.html"><i class="fab fa-google-plus-g"></i></a></li>
                    ...
                    <div class="team-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="inner">
                                    <h4><a href="agents-details.html">Marie Rose</a></h4>
                                    <span class="designation">Agent Sénior</span>
                                    <ul class="social-links clearfix">
                                        <li><a href="index.html"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="index.html"><i class="fab fa-twitter"></i></a></li>
                    ...
                    <div class="team-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="inner">
                                    <h4><a href="agents-details.html">Steven Kozaskiy</a></h4>
                    ...
                    <div class="team-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="inner">
                                    <h4><a href="agents-details.html">Fatima Daouzi</a></h4>
                                    <span class="designation">Agent Sénior</span>
                                    <ul class="social-links clearfix">
                                        <li><a href="index.html"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="index.html"><i class="fab fa-twitter"></i></a></li>
