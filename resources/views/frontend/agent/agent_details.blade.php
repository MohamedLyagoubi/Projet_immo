            ...
            <div class="auto-container">
                <div class="content-box clearfix">
                    ...
                    <ul class="bread-crumb clearfix">
                        <li><a href="index.html">Accueik</a></li>
                        <li>{{ $agent->name }}</li>
                    </ul>
                </div>
            </div>
...
<div class="text">
    <p>Le succès n’est pas vraiment si difficile. Il y a une partie importante de la population ici en Amérique du Nord qui veut et a besoin que le succès soit difficile ! Pourquoi? Ils ont alors une excuse intégrée quand les choses ne se passent pas comme ils le souhaitent ! Une situation pour le moins triste. Amusez-vous et hypnotisez-vous pour devenir votre propre futur Fantôme de Noël.”</p>
</div>
                ...
                <div class="inner-box">
                    <div class="image-box">
                       ...
                       @endif
                        ...
                        <div class="buy-btn"><a href="property-details.html">Pour {{ $item->property_status }}</a></div>
                    </div>
  ...
  @endif 
        ...
        <li><i class="icon-16"></i>{{ $item->property_size }} Sq Ft</li>
                        ...
                        <div class="other-info-box clearfix">
                            <div class="btn-box pull-left"><a href="{{ url('property/details/'.$item->id.'/'.$item->property_slug) }}" class="theme-btn btn-two">Voir les détails</a></div>
...
<div class="widget-title">
    <h5>Contacter pour {{ $agent->name }}</h5>
</div>
...
<form action="{{ route('agent.details.message') }}" method="post" class="default-form">
    ...
    <input type="hidden" name="agent_id" value="{{ $agent->id }}">
            ...
            <div class="form-group message-btn">
                <button type="submit" class="theme-btn btn-one">Envoyer Message</button>
            </div>
        </form>
...
<div class="widget-title">
    <h5>Statut de la propriété</h5>
</div>
<ul class="category-list clearfix">
    <li><a href="{{ route('rent.property') }}">A louer <span>({{ count($rentproperty) }})</span></a></li>
    <li><a href="{{ route('buy.property') }}">Pour Acheter<span>({{ count($buyproperty) }})</span></a></li>
</ul>
</div>
    ...
    <div class="feature-block-one">
        <div class="inner-box">
            ...
            <div class="lower-content">
                ...
                <div class="btn-box"><a href="{{ url('property/details/'.$feat->id.'/'.$feat->property_slug) }}" class="theme-btn btn-two">Voir les détails</a></div>
            </div>
        </div>
    </div>
@endforeach 
