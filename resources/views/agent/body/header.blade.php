          ...
          <ul class="navbar-nav">
                ...
                <div class="p-1">
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    ...
                    <div class="d-flex justify-content-between flex-grow-1">
                      <div class="me-4">
                        <p>Leo Matelier</p>
                        <p class="tx-12 text-muted">État d'avancement du projet</p>
                      </div>
                      <p class="tx-12 text-muted">2 min </p>
                    </div>  
                  </a>
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    <div class="me-3">
                    ...
                    <div class="d-flex justify-content-between flex-grow-1">
                      <div class="me-4">
                        <p>Samantha Beandre</p>
                        <p class="tx-12 text-muted">Réunion avec les clients</p>
                      </div>
                      <p class="tx-12 text-muted">30 min </p>
                    </div>  
                  </a>
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    <div class="me-3">
                    ...
                    <div class="d-flex justify-content-between flex-grow-1">
                      <div class="me-4">
                        <p>Yasmine Abderraman</p>
                        <p class="tx-12 text-muted">Mise à jour des projets</p>
                      </div>
                      <p class="tx-12 text-muted">1 hrs </p>
                    </div>  
                  </a>
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    <div class="me-3">
                    ...
                    <div class="d-flex justify-content-between flex-grow-1">
                      <div class="me-4">
                        <p>Amiah Burton</p>
                        <p class="tx-12 text-muted">Projet d'arrêt d'activité</p>
                      </div>
                      <p class="tx-12 text-muted">2 hrs </p>
                    </div>  
                  </a>
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    <div class="me-3">
                    ...
                    <div class="d-flex justify-content-between flex-grow-1">
                      ...
                      <p class="tx-12 text-muted">Il y a 5 hrs </p>
                    </div>  
                  </a>
                </div>
                <div class="px-3 py-2 d-flex align-items-center justify-content-center border-top">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu p-0" aria-labelledby="notificationDropdown">
                <div class="px-3 py-2 d-flex align-items-center justify-content-between border-bottom">
                  <p>Il y a 6 Nouvelles Notifications</p>
                  <a href="javascript:;" class="text-muted">Tout Supprimer</a>
                </div>
                <div class="p-1">
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                  ...
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    ...
                    <div class="flex-grow-1 me-2">
                      ...
                      <p class="tx-12 text-muted">Il y a 1 hrs </p>
                    </div>  
                  </a>
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    <div class="wd-30 ht-30 d-flex align-items-center justify-content-center bg-primary rounded-circle me-3">
                    ...
                    <div class="flex-grow-1 me-2">
                      ...
                      <p class="tx-12 text-muted">Il y a 2 sec</p>
                    </div>  
                  </a>
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    <div class="wd-30 ht-30 d-flex align-items-center justify-content-center bg-primary rounded-circle me-3">
                    ...
                    <div class="flex-grow-1 me-2">
                      <p>Les applications sont prêtes pour la mise à jour</p>
                      <p class="tx-12 text-muted">Il y a 5 hrs</p>
                    </div>  
                  </a>
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    ...
                    <div class="flex-grow-1 me-2">
                      ...
                      <p class="tx-12 text-muted">Il y a 6 hrs</p>
                    </div>  
                  </a>
                </div>
                <div class="px-3 py-2 d-flex align-items-center justify-content-center border-top">
      ...
      <a href="{{ route('admin.profile') }}" class="text-body ms-0">
                  ...
                  <li class="dropdown-item py-2">
                    <a href="javascript:;" class="text-body ms-0">
                      ...
                      <span>Changement d'utilisateur</span>
                    </a>
                  </li>
                  <li class="dropdown-item py-2">
