        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="{{ route('package.history') }}" class="nav-link">
              <i class="link-icon" data-feather="calendar"></i>
              <span class="link-title">Historique du Forfait </span>
            </a>
          </li>

          <li class="nav-item nav-category">Les composants</li>
          <li class="nav-item">
