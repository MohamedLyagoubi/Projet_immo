              ...
              <div class="card-body">
                <div class="container-fluid d-flex justify-content-between">
                  <div class="col-lg-3 ps-0">
                    <a href="#" class="noble-ui-logo logo-light d-block mt-3">Real Estate Agence<span>Store</span></a>                 
                    <p class="mt-1 mb-1"><b></b></p>
                    <p>12,<br> Avenue des Champs Elysée,<br>Paris</p>
                    <h5 class="mt-5 mb-2 text-muted">Facture de :</h5>
