	...
	<div class="page-content">
                    ...
                    <div class="col-md-4 stretch-card grid-margin grid-margin-md-0">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <div class="d-grid">
                            <button class="btn btn-primary mt-4">Commencez maintenant</button>
                          </div>
                        </div>
                      </div>
                    </div>
       ...
       <a href="{{ route('buy.business.plan') }}" class="btn btn-success mt-4">Commencez maintenant  </a> 
                    ...
                    <div class="col-md-4 stretch-card">
                      <div class="card">
                        <div class="card-body">
                          <h4 class="text-center mt-3 mb-4">Professionnel</h4>
                          ...
                          <table class="mx-auto">
                            ...
                            <tr>
                              <td><i data-feather="check" class="icon-md text-primary me-2"></i></td>
                              <td><p>Premium Assistance</p></td>
                            </tr>
                            
                          </table>
                          <div class="d-grid">
   <a href="{{ route('buy.professional.plan') }}" class="btn btn-primary mt-4">Commencer maintenant </a> 
                          </div>
                        </div>
                      </div>
                    </div>
