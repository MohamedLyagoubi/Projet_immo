              ...
              <div class="card-body">
                <div class="container-fluid d-flex justify-content-between">
                  <div class="col-lg-3 ps-0">
                    <a href="#" class="noble-ui-logo logo-light d-block mt-3">Real Estate<span>Agence</span></a>                 
                    <p class="mt-1 mb-1"><b>RealEstate</b></p>
                    <p>108,<br> Great Russell St,<br>London, WC1B 3NA.</p>
                    <h5 class="mt-5 mb-2 text-muted">Fcature de :</h5>
                      ...
                      <table class="table table-bordered">
                        <thead>
                          <tr>
                              ...
                              <th class="text-end">Quantité de propriété</th>
                        ...
                        <tbody>
                          <tr class="text-end">
                            ...
                            <td class="text-start">Professionnel</td>
                            <td>10</td>
                            <td>50 €</td>
                            <td>50 €</td>
                          </tr>
