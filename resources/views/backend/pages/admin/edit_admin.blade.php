...
<div class="page-content">
 ...
 <label for="exampleInputEmail1" class="form-label">Nom d'utilisateur administrateur   </label>
 ...
 <label for="exampleInputEmail1" class="form-label">Nom de l'administrateur   </label>
     <input type="text" name="name" class="form-control" value="{{ $user->name }}"> 
                ...
                <div class="form-group mb-3">
 <label for="exampleInputEmail1" class="form-label">E-mail de l'administrateur  </label>
     <input type="email" name="email" class="form-control" value="{{ $user->email }}"> 
                </div>


                <div class="form-group mb-3">
 <label for="exampleInputEmail1" class="form-label">Téléphone administrateur   </label>
 ...
 <label for="exampleInputEmail1" class="form-label">Adresse de l'administrateur  </label>
     <input type="text" name="address" class="form-control" value="{{ $user->address }}"> 
                ...
                <div class="form-group mb-3">
 <label for="exampleInputEmail1" class="form-label">Nom de rôle   </label>
