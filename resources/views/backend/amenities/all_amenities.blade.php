...
<div class="page-content">
				...
				<nav class="page-breadcrumb">
					<ol class="breadcrumb">
	  <a href="{{ route('add.amenitie') }}" class="btn btn-inverse-info"> Ajouter des équipements </a>
					</ol>
				</nav>
            ...
            <div class="card">
              <div class="card-body">
                <h6 class="card-title">Voir tous les équipements </h6>
