...
<div class="page-content">
  ...
  Add Category
            ...
            <div class="card">
              <div class="card-body">
              <h6 class="card-title">Toutes les catégories de blog </h6>
...
<div class="table-responsive">
    <table id="dataTableExample" class="table">
        <thead>
            <tr>
                <th>Numéro </th>
                <th>Nom de la catégorie de blog </th>
                <th>Slug de la catégorie de blog </th>
                <th>Action </th>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <label for="exampleInputEmail1" class="form-label">Nom de la catégorie de blog </label>
