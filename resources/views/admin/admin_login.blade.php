...
<head>
  ...
  <meta name="description" content="Responsive HTML Admin Dashboard Template based on Bootstrap 5">
	...
	<title>Page de connexion de l'administrateur</title>
...
<body>
			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo logo-light d-block mb-2">Business<span>UI</span></a>
  ...
  <label for="login" class="form-label">Email/Nom/Téléphone </label>
                 ...
                 Connexion
                      ...
                      <a href="register.html" class="d-block mt-3 text-muted">Vous n'êtes pas utilisateur ? S'inscrire</a>
                    </form>
